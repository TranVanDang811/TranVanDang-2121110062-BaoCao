...
@section('content')
    <form action="{{ route('brand.update',['brand'=>$brand->id]) }}" id="create"method="POST" enctype="multipart/form-data">
        @method('PUT')
        @csrf
                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                            <h6 class="text-white text-capitalize ps-2">{{ $title ?? 'CẬP NHẬT THƯƠNG HIỆU' }}</h6>
                            <div class="row">
                        ...
                        <div class="table-responsivee p-0">
                            ...
                            ">
                                    <div class="mb-3">
                                        ...
                                        <input id="name"name="name" type="text" class="form-control bg-light text-black"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="metakey"name="metakey" class="form-control bg-light text-black" rows="3" placeholder="Từ khóa">{{ old('metakey',$brand->metakey)}}</textarea>
                                        {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="metadesc"name="metadesc" class="form-control bg-light text-black" rows="3" placeholder="Mô tả">{{ old('metadesc',$brand->metadesc)}}</textarea>
                                        {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
