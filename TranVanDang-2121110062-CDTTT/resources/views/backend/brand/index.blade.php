                    ...
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                        ...
                        <div class="row">
                            <div class="col-md-12 " style="margin-left: 900px">
                                <a class="btn btn-sm btn-info" href="{{ route('brand.create') }}">
                            ...
                            <tbody>
                                ...
                                @foreach ($list as $brand)
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0 text-center"> {{ $brand->name }}</p>

                                        </td>
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0 text-center"> {{ $brand->slug }}</p>
