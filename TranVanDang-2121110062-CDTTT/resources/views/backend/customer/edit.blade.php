                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                            <h6 class="text-white text-capitalize ps-2">{{ $title ?? 'CẬP NHẬT KHÁCH HÀNG' }}</h6>
                            <div class="row">
                            ...
                            ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="email"name="email" type="text"
                                            ...
                                            value="{{ $customer->email }}"> {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
                                        @if ($errors->has('email'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="phone"name="phone" type="text"
                                            ...
                                            value="{{ $customer->phone }}"> {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
                                        @if ($errors->has('phone'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="address"name="address" type="text"
                                            ...
                                            value="{{ $customer->address }}"> {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
                                ...
                                <div class="col-md-4 ">
                                    <div class="mb-3">
                                        ...
                                        <input id="username"name="username" type="text"
                                            ...
                                            value="{{ $customer->username }}"> {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
