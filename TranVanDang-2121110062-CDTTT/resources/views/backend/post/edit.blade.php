                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                            <h6 class="text-white text-capitalize ps-2">{{ $title ?? 'CẬP NHẬT BÀI VIẾT' }}</h6>
                            <div class="row">
                            ...
                            ">
                                    <div class="mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control bg-light text-black"
                                            placeholder="Nhập tên bài viết" value="{{$post->title}}">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" type="text" class="form-control bg-light text-black"
                                            placeholder="Nhập miêu tả bài viết" cols="10" value="{{$post->description}}"></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="detail" id="editor1" rows="3" cols="80" value="{{$post->detail}}"></textarea>
