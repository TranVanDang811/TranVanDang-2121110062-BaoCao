                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                            <h6 class="text-white text-capitalize ps-2">{{ $title ?? 'THÊM DANH MỤC SẢN PHẨM' }}</h6>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-8 ">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        margin-left: 18px;
                                    "
                                            id="metakey"name="metakey" class="form-control bg-light text-black" rows="3" placeholder="Từ khóa">{{ old('metakey') }}</textarea>
                                        {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        margin-left: 18px;
                                    "
                                            id="metadesc" name="metadesc" class="form-control bg-light text-black" rows="3" placeholder="Mô tả">{{ old('metadesc') }}</textarea>
                                        {{-- <span class="text-danger alert" style="font-size:13px"></span> --}}
