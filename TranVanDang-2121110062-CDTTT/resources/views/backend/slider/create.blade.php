                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex">
                            <h6 class="text-white text-capitalize ps-2">{{ $title ?? 'THÊM SLIDER' }}</h6>
                            <div class="row">
                    ...
                    <div class="card-body px-0 pb-2">
                        <div class="table-responsivee p-0"  style="
                        width: 1187px;
                        margin-left: 18px;
                    ">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="name"name="name" type="text" class="form-control bg-light text-black"placeholder="Nhập tên slider">
                                <span class="text-danger alert" style="font-size:13px"></span>

                            </div>
                            <div class="mb-3">
                                <label class="form-label"><strong>Liên kết</strong></label>
                                <input id="link"name="link" type="text" class="form-control bg-light text-black"placeholder="#">
                                <span class="text-danger alert" style="font-size:13px"></span>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="status" class="form-control bg-light text-black" >
