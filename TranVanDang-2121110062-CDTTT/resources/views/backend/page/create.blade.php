...
@section('content')
    <form action="{{ route('page.store') }}" method="page" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card my-4">
                            ...
                            ">
                                    <div class="mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control bg-light text-black"
                                            placeholder="Nhập tên trang đơn" value="{{ old('title') }}">
                                        @if ($errors->has('title'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" type="text" class="form-control bg-light text-black"
                                            placeholder="Nhập miêu tả trang đơn" cols="10" value="{{ old('description') }}"></textarea>
