...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('https://fonts.googleapis.com/css?family=Roboto:300,400,500,700,900|Roboto+Slab:400,700') }}" />
    <!-- Nucleo Icons -->
    ...
    <script defer data-site="YOUR_DOMAIN_HERE" src="{{ asset('https://api.nepcha.com/js/nepcha-analytics.js') }}"></script>
</head>
                        ...
                        <div class="col-lg-4 col-md-8 col-12 mx-auto">
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-groups input-group-outline my-3">
                                        <label for="username">Tên đăng nhập</label>
                                        <input type="text" class="form-control border"
                                            placeholder="Tên đăng nhập hoặc email" style="padding-left: 10px"
                                            name="username" id="username" required>
                                    </div>
                                    <div class="input-groups input-group-outline my-3">
                                        <label for="password">Mật khẩu</label>
                                        <input type="password" class="form-control border"
                                            placeholder="Nhập mật khẩu" style="padding-left: 10px" name="password"
                                ...
                                <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                    ...
                                    <li class="nav-item">
                                        <a href="https://www.creative-tim.com/presentation"
                                            class="nav-link text-white" target="_blank">About Us</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="https://www.creative-tim.com/license"
                                            class="nav-link pe-0 text-white" target="_blank">License</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
