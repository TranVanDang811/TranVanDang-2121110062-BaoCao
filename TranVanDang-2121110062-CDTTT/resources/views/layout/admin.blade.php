...
<head>
    ...
    <link rel="stylesheet" href="{{ asset("https://cdn.datatables.net/v/dt/dt-1.13.4/datatables.min.css") }}">
    <!-- Font Awesome Icons -->
    ...
    <style>
        .bg-gradient-primary {
            background-image: linear-gradient(195deg, #6699FF 0%, #D81B60 100%)
        }
    </style>
...
<body class="g-sidenav-show  bg-gray-200">
    @includeIf('layout.mainmenu_admin')
